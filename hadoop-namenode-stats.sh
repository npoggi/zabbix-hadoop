...
#--------------------------------------------------------------------------------------------
export RAW_FILE="/tmp/${ZABBIX_NAME}_namenode.raw"
export DATA_FILE="/tmp/${ZABBIX_NAME}_namenode.txt"
export LOG_FILE="/tmp/${ZABBIX_NAME}_namenode.log"
...
: ${start_time:=0}
: ${hadoop_version:=0}
: ${file_and_directory_count:=0}
: ${dfs_blocks:=0}
: ${namenode_process_heap_size:=0}
: ${max_heap_size:=0}
: ${storage_unit:=0}
: ${configured_cluster_storage:=0}

: ${dfs_use_storage:=0}
: ${non_dfs_use_storage:=0}
: ${available_dfs_storage:=0}
: ${used_storage_pct:=0}
: ${available_storage_pct:=0}
: ${live_nodes:=0}
: ${dead_nodes:=0}
: ${decommissioned_nodes:=0}
: ${under_repllicated_nodes:=0}

: ${max_configured_storage:=0}
: ${max_configured_storage_node_name:=0}
: ${min_configured_storage:=0}
: ${min_configured_storage_node_name:=0}
: ${max_used_storage:=0}
: ${max_used_storage_node_name:=0}
: ${min_used_storage:=0}
: ${min_used_storage_node_name:=0}
: ${max_non_dfs_used_storage:=0}
: ${max_configured_storage_node_name:=0}
: ${min_non_dfs_used_storage:=0}
: ${min_non_dfs_used_storage_node_name:=0}
: ${max_free_storage:=0}
: ${max_free_storage_node_name:=0}
: ${min_free_storage:=0}
: ${min_free_storage_node_name:=0}
: ${max_used_storage_pct:=0}
: ${max_used_storage_pct_node_name:=0}
: ${min_used_storage_pct:=0}
: ${min_used_storage_pct_node_name:=0}
: ${max_free_storage_pct:=0}
: ${max_free_storage_pct_node_name:=0}
: ${min_free_storage_pct:=0}
: ${min_free_storage_pct_node_name:=0}

: ${node_level_storage_unit:=0}
...
$ZABBIX_NAME under_repllicated_nodes $under_repllicated_nodes
$ZABBIX_NAME max_configured_storage $max_configured_storage
